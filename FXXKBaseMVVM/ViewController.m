...
-(void)viewDidLayoutSubviews{
    ...
    CGFloat offset = SCREEN_HEIGHT/4;
    CGFloat offset1 = SCREEN_HEIGHT/3;
    
    [views mas_distributeViewsAlongAxis:MASAxisTypeVertical withFixedItemLength:40 leadSpacing:offset tailSpacing:offset1];
...
//        _logoutBtn.frame = CGRectMake(100, 100, 70, 30);
...
//        _pushBtn.frame = CGRectMake(100, 200, 70, 30);
